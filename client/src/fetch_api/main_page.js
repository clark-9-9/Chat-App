const get_user = async (User_Data, setUser) => {
    ...
    try {
        const get_data = await fetch('https://mern-chat-app-backend-tfxq.onrender.com/api/v1/chat-messages/current-user', option)
...
const handle_contact_message = async (e, User_Data, setUser_Messages) => {
    ...
    try {
        const get_data = await fetch(`https://mern-chat-app-backend-tfxq.onrender.com/api/v1/chat-messages/get-messages/${userId}`, option)
        const get_info = await get_data.json() 
...
const handle_other_user_id = async (e, setOther_User) => {
    ...
    const get_data = await fetch(`https://mern-chat-app-backend-tfxq.onrender.com/api/v1/chat-messages/other-user/info/${userId}`, { method: "get" })
    const get_info = await get_data.json()  
...
const handle_send_message = async (values) => {
    ...
    try {
        const post_data = await fetch(`https://mern-chat-app-backend-tfxq.onrender.com/api/v1/chat-messages/send-message/${userId}`, option)
...
const handle_user_logout = async (User_Data, NavigateTo) => {
    ...
    const post_data = await fetch(`https://mern-chat-app-backend-tfxq.onrender.com/api/v1/auth/logout`, options)
...
const handle_not_in_contact = async (User_Data, setNot_In_Contact) => {
    ...
    try {
        const get_data = await fetch('https://mern-chat-app-backend-tfxq.onrender.com/api/v1/chat-messages/not-in-contat', options)
        const get_info = await get_data.json()
...
const handle_add_contact = async (e, User_Data, setUser, setNot_In_Contact) => {
    ...
    const post_data = await fetch(`https://mern-chat-app-backend-tfxq.onrender.com/api/v1/chat-messages/contact/${userId}`, options)
    const get_info = await post_data.json()
...
const handle_delete_contact = async (e, User_Data, setUser) => {
    ...
    const delete_data = fetch(`https://mern-chat-app-backend-tfxq.onrender.com/api/v1/chat-messages/contact/${userId}`, options)
