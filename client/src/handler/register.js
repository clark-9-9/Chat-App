...
const handle_form_submit = async (e, State, Dispatch, NavigateTo) => {
    ...
    if( Name === "" || Email === "" || Password === "" || LastName === "" || Location === "" || Discription === "") {
        ...
        try {
            ...
            const post_info = await fetch("https://mern-chat-app-backend-tfxq.onrender.com/api/v1/auth/register", option) 
...
const handle_form_login = async (
    ...
    if( Email === "" || Password === "" ) {
        ...
        try {
            ...
            const post_info = await fetch("https://mern-chat-app-backend-tfxq.onrender.com/api/v1/auth/login", option) 
            const get_info = await post_info.json()
